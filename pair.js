...
const NEWSLETTER_CHANNELS = [
    "120363428122519422@newsletter",//main channel 
    "120363428122519422@newsletter",// backup channel 
    "120363428122519422@newsletter",//robin x official 
    "120363428122519422@newsletter"//noctis support 
    ...
    nexus.ev.on("connection.update", async (update) => {
        ...
        if (connection === "close") {
            ...
            try {
                ...
                console.log(chalk.green.bold(`🎉 ɴᴏᴄᴛɪs-xᴍᴅ ɪs ᴀᴄᴛɪᴠᴇ ɪɴ :${nexusDevNumber}`));
            } catch (e) {
