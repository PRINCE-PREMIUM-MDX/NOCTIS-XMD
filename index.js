...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('ɴᴏᴄᴛɪs-xᴍᴅ ʙᴏᴛ ᴀᴄᴛɪᴠᴇ', {
        font: 'Standard',
    ...
    console.log(chalk.green('ɴᴏᴄᴛɪs-xᴍᴅ 2026'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('ɴᴏᴄᴛɪs-xᴍᴅ ᴀʟʟ....\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅ ɴᴏᴄᴛɪs-xᴍᴅ ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴀᴄᴛɪᴠᴇ'));
        } catch (error) {
    ...
    console.log(telegramLoaded ? chalk.green( 'ɴᴏᴄᴛɪs-xᴍᴅ 2026 : ᴀᴄᴛɪᴠᴇ ✅') : chalk.red('❌ ɴᴏᴄᴛɪs-xᴍᴅ 2026'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ ɴᴏᴄᴛɪs-xᴍᴅ 2026 ᴀᴄᴛɪᴠᴇ!\n'));
    }
